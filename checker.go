...
// Updated signature to include volume
func (c *Checker) CheckKeyword(domain, keyword, country, startDate, endDate string, volume int) RankingResult {
	result := RankingResult{
		Domain:      domain,
		Keyword:     keyword,
		Country:     country,
		Volume:      volume, // Added this
